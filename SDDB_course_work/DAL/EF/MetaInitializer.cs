...
namespace DAL.EF
{
    public class MetaInitializer : DropCreateDatabaseAlways<MetaContext>
    {
        ...
        {
            ConnectionDetails conDet1 = new ConnectionDetails { Id = 1, DatabaseName = "|DataDirectory|\\cafedb.mdf", Host = "(localdb)\\MSSQLLocalDB", IntegratedSecurity = true };
            ConnectionDetails conDet2 = new ConnectionDetails { Id = 2, DatabaseName = "|DataDirectory|\\manufacturedb.mdf", Host = "(localdb)\\MSSQLLocalDB", IntegratedSecurity = true };
